...
import { GenerateIcon, EditIcon, CopyIcon, CheckIcon, UploadIcon, TrashIcon } from './components/Icons';
    ...
    <div className="min-h-screen bg-gem-onyx text-gem-white flex flex-col items-center p-4 sm:p-8">
      <main className="w-full max-w-6xl space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gem-slate p-6 rounded-lg shadow-2xl flex flex-col h-full">
            ...
            <div className="bg-gem-slate p-6 rounded-lg shadow-2xl flex flex-col space-y-6">
                <div>
                    <label htmlFor="action-timeline" className="block text-lg font-medium text-gem-silver mb-2">
                        Action Timeline
                    </label>
                    <div id="action-timeline" className="space-y-3">
                    ...
                    <button onClick={addAction} className="mt-3 text-sm text-gem-sky hover:text-sky-400 font-semibold">
                        + Add Action
                    </button>
                </div>
                
                 <div>
                    <label htmlFor="dialogue-timeline" className="block text-lg font-medium text-gem-silver mb-2">
                        Dialogue Timeline (Optional)
                    </label>
                    <div id="dialogue-timeline" className="space-y-3">
